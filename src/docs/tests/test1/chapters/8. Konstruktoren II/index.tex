...
Wenn ein Konstruktor nicht explizit einen Konstruktor seiner Elternklasse aufruft, ruft er implizit \code{super()} auf.
...
Es ist zu beachten, dass jede Klasse in Java direkt oder indirekt von \code{java.lang.Object} erbt~\footnote{
...
führt das Erzeugen eines Objektes vom Typ \code{C} zu einem Compiler-Fehler, da \code{B} keinen parameterlosen
...
Damit ein Objekt vom Typen \code{C} erzeugt werden kann, benötigt \code{C} einen Standardkonstruktor mit einem expliziten
