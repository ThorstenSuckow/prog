...
Vererbung \unerline{nicht zu den vererbbaren Eigenschaften} (wie bspw. Methoden oder Attribute, je nach Sichtbarkeit)
zählen \footnote{
...
Es folgen ergänzende Beispiele, deren Funktionsweise den Quelltextkommentaren zu entnehmen ist.
