...
\title{\begin{center}
		   ...
		   \textbf{Test 4 - Dynamische Datenstrukturen und spezifische Algorithmen}\\
\\
...
\address{\begin{center}
			 \small{09.01.2024\\  Thorsten Suckow-Homberg, \url{https://thorsten.suckow-homberg.de}}
...
\input{chapters/1. Binärer Suchbaum/index}
\input{chapters/2. Datenstrukturen/index}
\input{chapters/3. delete/index}
\input{chapters/4. Pre-, In- und Postorder/index}
\input{chapters/5. Reihenfolge-Kombinationen/index}
\input{chapters/6. Eigenschaften binärer Bäume/index}
\input{chapters/7. Einfügen in einen Suchbaum II/index}
\input{chapters/8. Verkettete Listen und Arrayimplementierung/index}
\input{chapters/9. Hashfunktion/index}
