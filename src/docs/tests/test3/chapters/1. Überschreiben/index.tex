...
Eine Klasse \code{FigurenFabrik} sei nun folgendermaßen gegeben:
...
Eine Klasse, die nun von \code{FigurenFarik} erbt und \code{erzeugeQuadrat} überschreiben möchte,
