\usepackage{amsmath}\chapter{5. McCarthy Funktion}
...
Die maximale Rekursionstiefe kann für die \code{McCarthy 91}-Methode wie folgt ermittelt werden (s. Listing~\ref{lst:mccarthy}):
