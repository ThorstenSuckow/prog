...
Zur Lösung der Aufgabe genügt es, randomisierte Felder zu erzeugen und zu überprüfen, ob sich die Aufrufanzahl von $c3$ innerhalb gewisser Bereiche bewegt. Uns interessieren vor allem die folgenden Intervalle$\footnote{ab einem bestimmten $n$ wird $n\ log\ n$ kleiner als $n^1.3$, siehe dazu Tabelle~\ref{tab:calls}}:
