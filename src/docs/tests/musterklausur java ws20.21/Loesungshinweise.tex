...
%--------------------------------------------------------------------------
	...
	\address{\begin{center}
				 \small{04.03.2024\\  Thorsten Suckow-Homberg, \url{https://thorsten.suckow-homberg.de}}
...
% Die Kapitel werden in separaten .tex-Dateien abgelegt und hier eingebunden.
	\input{chapters/1. Klassen und Objekte/index}
	\input{chapters/2. Vererbung/index}
	\input{chapters/3. Felder, Anweisungen, Ausdrücke/index}
	\input{chapters/4. Zeichenketten/index}
	\input{chapters/5. Binäre Bäume/index}
	\input{chapters/6. Verkettete Liste/index}
	\input{chapters/7. Sortierverfahren/index}
	\input{chapters/8. Hashing/index}
	\input{chapters/9. Rekursion/index}
	\input{chapters/10. O-Notation/index}
