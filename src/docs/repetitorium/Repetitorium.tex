...
%--------------------------------------------------------------------------
	...
	\address{\begin{center}
				 \small{07.02.2024\\  Thorsten Suckow-Homberg, \url{https://thorsten.suckow-homberg.de}}
...
% Die Kapitel werden in separaten .tex-Dateien abgelegt und hier eingebunden.
	\input{chapters/1. Datentypen und Co/index}
	\input{chapters/2. Exceptions/index}
