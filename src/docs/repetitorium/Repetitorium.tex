...
%--------------------------------------------------------------------------
	...
	\address{\begin{center}
				 \small{11.03.2024\\  Thorsten Suckow-Homberg, \url{https://thorsten.suckow-homberg.de}}
...
% Die Kapitel werden in separaten .tex-Dateien abgelegt und hier eingebunden.
	\input{chapters/Grundlagen/index}
	\input{chapters/OOP/index}
	\input{chapters/Exceptions/index}
	\input{chapters/Exceptions/anmerkungen}
	\input{chapters/Datenstrukturen und Algorithmen/index}
	\input{chapters/Sortierverfahren/index}
