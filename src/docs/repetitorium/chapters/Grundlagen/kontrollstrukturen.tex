...
Wenn keine \code{case}-Label mit entsprechendem \code{case}\code{constant} dem ausgewerteten Ausdruck entspricht, wird das durch die \code{default}-Label eingeführte Anweisung aufgerufen.\\
